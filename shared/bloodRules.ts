// Blood Compatibility Rules & Clinical Disclaimers
...
export const CLINICAL_DISCLAIMER = 
  'BloodBridge is an emergency coordination tool. Blood compatibility matching scores are used exclusively for prioritization. Clinical eligibility, infectious disease screening, and serological cross-matching must be performed by authorized medical personnel.';
...
export function isBloodCompatible(donorGroup: BloodGroup, recipientGroup: BloodGroup): boolean {
  const compatibleDonors = RECIPIENT_COMPATIBILITY_MAP[recipientGroup];
 ...
 */
export function getBloodGroupScore(donorGroup: BloodGroup, recipientGroup: BloodGroup): number {
