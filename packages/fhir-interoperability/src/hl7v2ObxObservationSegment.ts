/**
 * BloodBridge FHIR & HL7 Interoperability Engine — HL7 v2 Observation Result OBX Segment Blood Grouping
 * Compliant with HL7 FHIR Release 4 / Release 5 and ISBT 128 standards.
 */

export interface HL7v2ObxSegment {
  resourceType: string;
  id: string;
...
export const HL7V2OBXOBSERVATIONSEGMENT_DATASET: HL7v2ObxSegment[] = [
  {
    resourceType: 'HL7v2ObxSegment',
    id: 'FHIR-HL7V-0001',
    status: 'completed',
    identifier: [
    ...
    meta: {
      ...
      profile: ['https://bloodbridge.org/fhir/StructureDefinition/HL7v2ObxSegment']
    }
  },
  {
    resourceType: 'HL7v2ObxSegment',
...
export function serializeHL7v2ObxSegmentToJson(resource: HL7v2ObxSegment): string {
  return JSON.stringify(resource, null, 2);
}

export function validateHL7v2ObxSegment(resource: HL7v2ObxSegment): boolean {
