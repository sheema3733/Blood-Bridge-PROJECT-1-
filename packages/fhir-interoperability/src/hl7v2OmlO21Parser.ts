/**
 * BloodBridge FHIR & HL7 Interoperability Engine — HL7 v2.5.1 OML_O21 Lab Order Message Definition
 * Compliant with HL7 FHIR Release 4 / Release 5 and ISBT 128 standards.
 */

export interface HL7v2LabOrderMessage {
  resourceType: string;
  id: string;
...
export const HL7V2OMLO21PARSER_DATASET: HL7v2LabOrderMessage[] = [
  {
    resourceType: 'HL7v2LabOrderMessage',
    id: 'FHIR-HL7V-0001',
    status: 'completed',
    identifier: [
    ...
    meta: {
      ...
      profile: ['https://bloodbridge.org/fhir/StructureDefinition/HL7v2LabOrderMessage']
    }
  },
  {
    resourceType: 'HL7v2LabOrderMessage',
...
export function serializeHL7v2LabOrderMessageToJson(resource: HL7v2LabOrderMessage): string {
  return JSON.stringify(resource, null, 2);
}

export function validateHL7v2LabOrderMessage(resource: HL7v2LabOrderMessage): boolean {
