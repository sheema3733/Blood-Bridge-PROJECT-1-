/**
 * BloodBridge FHIR & HL7 Interoperability Engine — HL7 v2.5.1 ORU_R01 Immunohematology Result Message
 * Compliant with HL7 FHIR Release 4 / Release 5 and ISBT 128 standards.
 */

export interface HL7v2ObservationMessage {
  resourceType: string;
  id: string;
...
export const HL7V2ORUR01PARSER_DATASET: HL7v2ObservationMessage[] = [
  {
    resourceType: 'HL7v2ObservationMessage',
    id: 'FHIR-HL7V-0001',
    status: 'completed',
    identifier: [
    ...
    meta: {
      ...
      profile: ['https://bloodbridge.org/fhir/StructureDefinition/HL7v2ObservationMessage']
    }
  },
  {
    resourceType: 'HL7v2ObservationMessage',
...
export function serializeHL7v2ObservationMessageToJson(resource: HL7v2ObservationMessage): string {
  return JSON.stringify(resource, null, 2);
}

export function validateHL7v2ObservationMessage(resource: HL7v2ObservationMessage): boolean {
