/**
 * BloodBridge FHIR & HL7 Interoperability Engine — FHIR ValueSet Blood Components & Derivatives
 * Compliant with HL7 FHIR Release 4 / Release 5 and ISBT 128 standards.
 */

export interface FhirValueSetRecord {
  resourceType: string;
  id: string;
...
export const FHIRVALUESETBLOODPRODUCTS_DATASET: FhirValueSetRecord[] = [
  {
    resourceType: 'FhirValueSetRecord',
    id: 'FHIR-FHIR-0001',
    status: 'completed',
    identifier: [
    ...
    meta: {
      ...
      profile: ['https://bloodbridge.org/fhir/StructureDefinition/FhirValueSetRecord']
    }
  },
  {
    resourceType: 'FhirValueSetRecord',
...
export function serializeFhirValueSetRecordToJson(resource: FhirValueSetRecord): string {
  return JSON.stringify(resource, null, 2);
}

export function validateFhirValueSetRecord(resource: FhirValueSetRecord): boolean {
